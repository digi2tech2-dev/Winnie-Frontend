...
function Stat({label,value,icon:Icon,tone}){const c={violet:"bg-violet-500/10 text-violet-600",sky:"bg-sky-500/10 text-sky-600",orange:"bg-orange-500/10 text-orange-600",emerald:"bg-emerald-500/10 text-emerald-600"}[tone];return <article className="rounded-[20px] border border-slate-200 bg-white p-3 dark:border-white/10 dark:bg-[#111827]"><Icon className={`h-8 w-8 rounded-xl p-2 ${c}`}/><strong className="mt-2 block text-2xl font-black dark:text-white">{value.toLocaleString("ar-EG")}</strong><p className="text-[9px] font-black text-slate-400">{label}</p></article>}
