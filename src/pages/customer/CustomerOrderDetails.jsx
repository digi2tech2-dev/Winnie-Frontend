...
function getCustomerStatusMessage(order = {}, isArabic) {
  ...
  if (isArabic) {
    ...
    if (teamFulfillment) return "طلبك قيد التنفيذ";
    if ((status === "PROCESSING" || status === "PENDING") && executionMode === "AUTO_PROVIDER") return "يتم تنفيذ الطلب تلقائياً";
  ...
  if (teamFulfillment) return "Your order is being processed.";
  if ((status === "PROCESSING" || status === "PENDING") && executionMode === "AUTO_PROVIDER") return "The order is being processed automatically.";
