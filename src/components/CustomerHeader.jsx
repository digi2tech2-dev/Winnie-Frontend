        ...
        <div className="winnie-mobile-topbar-shell relative mx-auto grid max-w-[1120px] grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 sm:gap-3">
          ...
          <div className="winnie-mobile-left-actions col-start-1 row-start-1 flex items-center justify-self-start gap-2 sm:gap-3">
            ...
            <div ref={notificationsRef} className="relative">
              ...
              {notificationsOpen ? (
                <div dir={isArabic ? "rtl" : "ltr"} role="dialog" aria-label={t("nav.notifications")} className="customer-notifications-popover absolute left-0 top-[calc(100%+12px)] z-[90] w-[min(420px,calc(100vw-24px))] overflow-hidden rounded-[28px] border border-violet-200/80 bg-white/95 text-start shadow-[0_28px_80px_rgba(76,29,149,0.28),0_0_0_1px_rgba(255,255,255,0.65)] backdrop-blur-2xl dark:border-violet-400/20 dark:bg-[linear-gradient(160deg,rgba(15,18,38,0.98),rgba(7,11,25,0.98))] dark:shadow-[0_30px_90px_rgba(0,0,0,0.58),0_0_35px_rgba(139,92,246,0.14)]">
                  ...
                  <div className="max-h-[390px] overflow-y-auto">
                    {notificationsLoading ? (
                      ...
                      latestNotifications.map((notification) => {
                        ...
                        return (
                          <button key={notification.id} type="button" onClick={() => openNotification(notification)} className={`group relative flex w-full items-start gap-3 border-b border-slate-100 px-4 py-3.5 text-start transition last:border-b-0 hover:bg-violet-50/80 dark:border-white/10 dark:hover:bg-white/[0.055] ${notification.unread ? "bg-[linear-gradient(90deg,rgba(245,243,255,0.95),rgba(240,249,255,0.62))] dark:bg-[linear-gradient(90deg,rgba(124,58,237,0.12),rgba(14,165,233,0.04))]" : ""}`}>
