...
export default function GroupCard({ group, labels, locale, memberCount, onEdit, onDelete }) {
  ...
  return (
    <article className="admin-group-card relative overflow-hidden rounded-[23px] border border-slate-200/90 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:border-violet-200 dark:border-white/[0.08] dark:bg-[#111827] dark:shadow-[0_0_20px_rgba(139,92,246,0.09)]">
      ...
      <div className="admin-group-metrics mt-4 grid grid-cols-2 gap-2">
      ...
      <div className="admin-group-actions mt-3 grid grid-cols-2 gap-2">
