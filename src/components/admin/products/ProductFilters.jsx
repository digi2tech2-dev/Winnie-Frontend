  ...
  return (
    <form onSubmit={onSearch} className="px-1 sm:px-2">
      <div className="flex flex-wrap items-center gap-2">
        <label className="site-filter-search relative min-w-[220px] flex-1 sm:max-w-sm"><span className="site-filter-search-icon admin-products-search-icon pointer-events-none"><Search className="h-4 w-4" /></span><input type="text" value={filters.query} onChange={update("query")} aria-label="البحث في المنتجات" placeholder="ابحث باسم المنتج" className={`${inputClassName} site-filter-search-input admin-products-panel-input`} /></label>
